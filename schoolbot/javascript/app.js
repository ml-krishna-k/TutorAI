...
class MindMateApp {
    ...
    loadNeetJeePage() {
        ...
        setTimeout(() => {
            try {
                window.location.href = 'classes/jeeneet/index.html';
            } catch (error) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const classButtons = {
        'class1Btn': 'classes/class1/index.html',
        'class2Btn': 'classes/class1/index.html',
        'class3Btn': 'classes/class1/index.html',
        'class4Btn': 'classes/class1/index.html',
        'class5Btn': 'classes/class5/index.html',
        'class6Btn': 'classes/class5/index.html',
        'class7Btn': 'classes/class5/index.html',
        'class8Btn': 'classes/class5/index.html',
        'class9Btn': 'classes/class5/index.html',
        'class10Btn': 'classes/class10/index.html',
        'class11Btn': 'classes/class10/index.html',
        'class12Btn': 'classes/class10/index.html'
    };
